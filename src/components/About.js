...
import Process from './Process'; // Import the Process component
import '../styles.css';
...
function About() {
  return (
    <>
      ...
      <Process /> {/* Embed Process component */}
      <Services /> {/* Embed Services component */}
      <Pricing /> {/* Embed Pricing component */}
    </>
  );
}
